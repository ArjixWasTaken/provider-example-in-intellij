...
import com.lagradost.cloudstream3.ConsoleColors
...
fun logError(throwable: Throwable) {
    println(ConsoleColors.RED + "ApiError:\t" + "-------------------------------------------------------------------")
    println("ApiError:\t" + "safeApiCall: " + throwable.localizedMessage)
    println("ApiError:\t" + "safeApiCall: " + throwable.message)
    throwable.printStackTrace()
    println("ApiError:\t" + "-------------------------------------------------------------------" + ConsoleColors.RESET)
}


fun <T> safeApiCall(apiCall: () -> T): T? {
    return try {
        apiCall.invoke()
...
data class TvSeriesEpisode(
    ...
    val date: String? = null,
    val rating: Int? = null,
    val descript: String? = null,  // blue is too lazy to fix this typo
)
